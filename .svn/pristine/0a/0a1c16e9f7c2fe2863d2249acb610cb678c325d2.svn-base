...
if (substr(env('HTTP_HOST'), -17) == 'servidorprueba.com.ar') {
       Configure::write('isTestServer', true);
} else {
       Configure::write('isTestServer', false);
}
...
Configure::write('brwSettings', array(
       ...
       'companyName' => 'ETUR - Panel de Administración',
));
